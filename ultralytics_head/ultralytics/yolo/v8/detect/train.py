...
class DetectionTrainer(BaseTrainer):
    ...
    def build_dataset(self, img_path, mode='train', batch=None):
        ...
        return build_yolo_dataset(self.args, img_path, batch, self.data, mode=mode, rect=(True if mode == 'val' else False),
                                  stride=gs,use_rir=self.args.use_rir,val_flag=False,use_simotm=self.args.use_simotm)
