...
custom_yaml_path = 'ultralytics_attention/yolov8+OCCAPCC_layer6.yaml'
model_save_path = '../results/saved_models/yolov8+attention_layer6_best.pt'
...
# train model
print(f'Loading YAML: {custom_yaml_path}')
